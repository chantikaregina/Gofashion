            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="{{ asset('assets/images/profile/user-3.jpg') }}" alt="" width="35" height="35" class="rounded-circle">
                </a>
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by <a href="" target="_blank"
              class="pe-1 text-primary text-decoration-underline">Gofashion</a>Distributed by <a href="" target="_blank"
              class="pe-1 text-primary text-decoration-underline">Gofashion</a></p>
        </div>
      </div>
    </div>
  </div>
