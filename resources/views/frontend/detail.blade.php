                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group quantity mb-5" style="width: 100px;">
                            ...
                            <input type="text" class="form-control form-control-sm text-center border-0" value="1" id="quantity-input" name="quantity">
                            <div class="input-group-btn">
                                <button class="btn btn-sm btn-plus rounded-circle bg-light border" type="button" id="btn-plus">
                        ...
                        <form action="{{ route('add.to.cart') }}" method="POST" class="d-inline">
                            ...
                            <input type="hidden" id="hidden-quantity" name="quantity" value="1"> <!-- Nilai yang akan dikirim -->
