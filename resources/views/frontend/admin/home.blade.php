                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative sweater-item">
                                            <div class="sweater-img">
                                                <img src="{{ asset('assets_main/img/sweater.7.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Sweater</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative sweater-item">
                                            <div class="sweater-img">
                                                <img src="{{ asset('assets_main/img/sweater.6.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Sweater</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative sweater-item">
                                            <div class="sweater-img">
                                                <img src="{{ asset('assets_main/img/sweater.4.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Sweater</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative sweater-item">
                                            <div class="sweater-img">
                                                <img src="{{ asset('assets_main/img/sweater.5.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Sweater</div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative jaket-item">
                                            <div class="jaket-img">
                                                <img src="{{ asset('assets_main/img/jaket.1.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Jaket</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative jaket-item">
                                            <div class="jaket-img">
                                                <img src="{{ asset('assets_main/img/jaket.4.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Jaket</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative jaket-item">
                                            <div class="jaket-img">
                                                <img src="{{ asset('assets_main/img/jaket.3.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Jaket</div>
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative dress-item">
                                            <div class="dress-img">
                                                <img src="{{ asset('assets_main/img/dress.2.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Dress</div>
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative celana-item">
                                            <div class="celana-img">
                                                <img src="{{ asset('assets_main/img/celana.4.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Celana</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative celana-item">
                                            <div class="celana-img">
                                                <img src="{{ asset('assets_main/img/celana.2.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Celana</div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative celana-item">
                                            <div class="celana-img">
                                                <img src="{{ asset('assets_main/img/celana.3.png') }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                style="top: 10px; left: 10px;">Celana</div>
...
=======
>>>>>>> 30fa4a3a87e8d3c44e5e756bc30b7f44f7e2f4fb
